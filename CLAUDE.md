...
- `requirements.txt` — only dependency: `progressbar2`
...
- The "personal configuration" section (bottom of script, after line 309) is user-specific and should not be treated as canonical logic.
