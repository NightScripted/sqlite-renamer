...
- The "personal configuration" section (lines 326–352) contains the user's tag-to-template mappings and path filters. Treat it as user data: when editing it, confirm the user's intended tag names and templates rather than inferring from the rest of the script.
